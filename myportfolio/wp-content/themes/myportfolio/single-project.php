...
/*
Template Name: Single Proejct Template
*/
...
<section id="portfolio-projects">
      <div class="container">
        <div class="project-image">
          <div class="img" style="background: url('<?= $image_properties[url]; ?>')"></div>
        </div>
        <h1><?= $name; ?></h1>
        <div class="info">
          <div class="buttons">
            <a href="<?= $project_url; ?>"><i class="fas fa-desktop"></i> View Project</a>
            <a href="<?= $github_url; ?>"><i class="fas fa-code"></i> View Code</a>
          </div>
        </div>
        <p><?= $description; ?></p>
        ...
        <div class="video">
          ...
          <iframe width="560" height="315" src="https://www.youtube.com/embed/<?= $youtube_url; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
      </div>
    </section>
