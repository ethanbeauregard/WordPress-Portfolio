      ...
      <div class="container">
        ...
        <?php 
          ...
          <?php while($mypod->fetch()) : ?>
            ...
            ?>
            <a href="<?= $permalink; ?>" class="box image<?= $loopIndex; ?>">
              <div class="image" style='background: url("<?= $image_properties[url]; ?>");
                height: 100%;
                width: 100%;
                ...
                <div class="hover-bg">
                  <div class="title">
                    <div class="text"><?= $type_of_project; ?></div>
                  </div>
                </div>
              </div>
            </a>
